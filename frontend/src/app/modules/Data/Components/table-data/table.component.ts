...
export class TableDataComponent implements OnChanges,OnInit {
  ...
  constructor(private modalService: NzModalService,private readonly dataService:DataService, private notification: NzNotificationService, private router: Router) { 
  }
