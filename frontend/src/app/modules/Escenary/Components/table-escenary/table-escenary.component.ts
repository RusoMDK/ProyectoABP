...
@Component({
  selector: 'app-table-escenary',
  templateUrl: './table-escenary.component.html',
  styleUrls: ['./table-escenary.component.css']
})
export class TableEscenaryComponent implements OnChanges,OnInit {
  ...
  constructor(private modalService: NzModalService,private readonly escenaryService:EscenaryService, private notification: NzNotificationService, private router: Router) { 
  }
