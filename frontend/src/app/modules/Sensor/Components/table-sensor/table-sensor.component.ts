...
@Component({
  ...
  templateUrl: './table-sensor.component.html',
  styleUrls: ['./table-sensor.component.css']
})
export class TableSensorComponent implements OnChanges,OnInit {
  ...
  constructor(private modalService: NzModalService,private readonly sensorService:SensorService, private notification: NzNotificationService, private router: Router) { 
  }
